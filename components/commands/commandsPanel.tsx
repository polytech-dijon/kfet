  ...
  return (
    <>
      ...
      <div className="my-4">
        ...
        <NewCommandModal
          isOpen={isNewCommandOpen}
          onClose={() => setIsNewCommandOpen(false)}
          onSubmit={createCommand}
          articles={articles}
        />
        <EditCommandArticleModal
          isOpen={isEditingCommandOpen}
          onClose={() => setIsEditingCommandOpen(false)}
      ...
      <div>
        {commands.length === 0 && (
          <div className="flex justify-center">Aucune commande trouvée.</div>
        )}
        {commands.length > 0 && (
            ...
            <table className="w-full text-sm text-left text-gray-500">
              ...
              <tbody>
                {commands.map((command) => (
                  <tr key={command.id} className="bg-white">
                    <th
                      scope="row"
                    ...
                    >
                      <CommandNameField
                        ...
                        setNewName={(newName: string) =>
                          updateCommand({ ...command, title: newName })
                        }
                      />
                    </th>
                    <td className="px-6 py-4">
                      ...
                      <IconButton onClick={() => openEditArticleModal(command)}>
                        <EditIcon />
                      </IconButton>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      ...
                      Il y a{" "}
                      <Timer
                        acceptable_wait_time={15}
                        long_wait_time={20}
                        created_at={command.created_at as unknown as number}
                      />
                    </td>
                    <td className="px-6 py-4">
